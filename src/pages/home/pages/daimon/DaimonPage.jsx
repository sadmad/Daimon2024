      ...
      <Row className="vh-100">
        <Col xs={12} className="text-center">
          ...
          <motion.div
            ...
            >
              <Row><Col><h2>Decision Aid for Marine Munitions: Practical Application</h2></Col></Row>
            </motion.div>
        </Col>
      </Row>
          ...
          <Row className="flex-grow-1 align-items-center justify-content-center">
            ...
            >
              <p>
                ...
                (2016-2019), with a budget of 4.7 million EUR and part-financed
                by the EU INTERREG Baltic Sea Region Programme, addressed the
                contentious issue of how to manage these underwater warfare
                objects. They developed decision-aid tools to assist Baltic Sea
                Region governments and companies in making informed,
